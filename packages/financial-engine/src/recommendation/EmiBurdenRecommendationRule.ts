...
export class EmiBurdenRecommendationRule implements RecommendationRule {
  ...
  public create(finding: Finding): Recommendation {
    return Object.freeze({ title: "Reduce EMI burden", description: "Lower recurring debt repayments to improve cash-flow resilience.", priority: Priority.HIGH, expectedScoreIncrease: 5, sourceFindingCode: finding.code, sourceFindingVersion: finding.version, measurableTarget: "EMI-to-income ratio below 30%" });
  }
}
